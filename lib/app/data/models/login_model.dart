...
class User {
    ...
    User({this.id, this.name, this.email, this.phone, this.emailVerifiedAt, this.latitude, this.longitude, this.address, this.countryId, this.cityId, this.fcmToken, this.isNotification, this.createdAt, this.updatedAt});
