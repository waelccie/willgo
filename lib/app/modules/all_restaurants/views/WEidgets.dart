...
class AllResturantWidget extends StatefulWidget {
  const AllResturantWidget({super.key,required this.image,required this.name,required this.time,required this.id,required this.rate});
          ...
          children: [
            ...
            Column(
              ...
              children: [
                ...
                Row(
                  children: [
                    Icon(Icons.access_time_sharp,color: const Color(0xff878787),weight: 0.1,),
                    SizedBox(width: 3.w,),
                    ...
                    Text(widget.rate.toString(),style:  GoogleFonts.dmSans(fontSize: 14,fontWeight: FontWeight.w400,color: const Color(0xff878787)),),
