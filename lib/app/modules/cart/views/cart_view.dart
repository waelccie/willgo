                    ...
                    children: [
                      CustomFutureBuilder(
                        ...
                        onData: (BuildContext context, Cart data) {
                          ...
                          return data.data == null || data.data!.data!.isEmpty
                              ? Center(
                                  child: Column(
                                    crossAxisAlignment:
                              ...
                              : Container(
                                  ...
                                  child: ListView.separated(
                                    ...
                                    itemBuilder: (context, index) {
                                      return cartItem(
                                        name:
                                            cart?.data?[index].product?.enName,
                                        image: cart
                                            ?.data?[index].product?.images?[0],
                                        cat: cart?.data?[index].product
                                            ?.category?.nameEn,
                                        price: cart?.data?[index].totalPrice,
                                        initialQuantity:
                                            cart?.data?[index].quantity ?? 0,
                      ...
                      CustomFutureBuilder(
                        future: controller.getCart,
                        onData: (BuildContext context, Cart data) {
                          return data.data == null || data.data?.totalItems == 0
                              ? Container()
                              : Column(
                                  children: [
