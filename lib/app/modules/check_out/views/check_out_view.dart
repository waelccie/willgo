              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                              ...
                              children: [
                                Column(
                                  ...
                                  children: [
                                    ...
                                    if (controller.getDelvryLocation?.data
                                                ?.streetName ==
                                            null ||
                                        controller.getDelvryLocation?.data ==
                                            null)
                                      Text(
                                        "steeet",
                    ...
                    order_address(
                      name: controller.getDelvryLocation?.data?.buildingName ??
                          "location Name",
                      address: controller.getDelvryLocation?.data?.address ??
                          "addess",
                    ),
                    Padding(
                    ...
                    AppProgressButton(
                      onPressed: (c) {
                        if (radioSelected == 1 &&
                            controller.getDelvryLocation?.data?.id != null) {
                          controller.checkOut(
