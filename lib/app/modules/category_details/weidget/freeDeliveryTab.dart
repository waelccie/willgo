...
class freeDeliveryTab extends StatefulWidget {
  const freeDeliveryTab({super.key,required this.image,required this.name,required this.time,required this.id,required this.rate});
      ...
      child: Container(
        child: Row(
          children: [
            ...
            const Spacer(),
            const Icon(FontAwesomeIcons.heart,color: Color(0xff78828A),)
          ],
        ),
      ),
    );
