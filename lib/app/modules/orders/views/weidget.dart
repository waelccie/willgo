          ...
          child: Column(
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  Text(
                    'Total Items (${orderModel.data!.orderProducts.length})',
                    style: GoogleFonts.inter(
                  ...
                  Text(
                    '${AppConstants.appCurrency} ${orderModel.data!.total}',
                    style: GoogleFonts.inter(
              ...
              Row(
                ...
                children: [
                  ...
                  Text(
                    "+${orderModel.data!.deliveryFee.toString()}",
                    style: GoogleFonts.inter(
                        fontWeight: FontWeight.w700, fontSize: 14),
                  )
                ],
              ...
              Row(
                ...
                children: [
                  ...
                  Text(
                    '-${AppConstants.appCurrency} ${orderModel.data!.discount}',
                    style: GoogleFonts.inter(
              ...
              Row(
                ...
                children: [
                  ...
                  Text(
                    '${AppConstants.appCurrency} ${orderModel.data!.finalTotal}',
                    style: GoogleFonts.inter(
                        fontWeight: FontWeight.w700, fontSize: 14),
                  )
                ],
          ...
          child: Column(
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  Text(
                    details.data!.restaurant!.arName.toString(),
                    style: GoogleFonts.inter(
                        fontWeight: FontWeight.w600,
                        fontSize: 16,
                  ...
                  Text(
                    details.data!.restaurant!.address.toString(),
                ...
                child: ListView.separated(
                    itemBuilder: (context, index) {
                      return Row(
                        ...
                        children: [
                          Text(
                            details.data!.orderProducts[index].product!.enName
                                .toString(),
                            style: GoogleFonts.almarai(
...
Widget order_address(BuildContext context, OrderDetailsModel details) =>
    Padding(
      padding: const EdgeInsets.symmetric(
        vertical: 10.0,
      ),
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
                ...
                TextSpan(children: [
                  TextSpan(
                      ...
                      style: GoogleFonts.roboto(
                          ...
                          color: const Color(0xff101010))),
                  TextSpan(
                      text: details.data!.location?.address.toString(),
                      style: GoogleFonts.inter(
              ...
              Text(details.data!.location!.streetName.toString(),
                  style: GoogleFonts.inter(
                      fontSize: 14.27, fontWeight: FontWeight.w600))
            ],
          ),
        ),
      ),
...
Widget paymentdetails(BuildContext context, OrderDetailsModel details) =>
    Padding(
      padding: const EdgeInsets.symmetric(
        vertical: 10.0,
      ),
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              Text('Payment method ',
                  style: GoogleFonts.inter(
                      fontSize: 15.27, fontWeight: FontWeight.w400)),
              const SizedBox(
                height: 8,
              ),
              Text(details.data!.paymentMethod.toString(),
                  style: GoogleFonts.inter(
                      fontSize: 15.27, fontWeight: FontWeight.w600))
            ],
          ),
...
Widget cancelBottom_sheet() {
  return Column(
    children: [
      ...
      Text(
        "Cancelled orders within minutes of the order will \nnot be charged any fees ",
        textAlign: TextAlign.center,
        style: GoogleFonts.dmSans(
            fontSize: 14,
            color: const Color(0xff878787),
