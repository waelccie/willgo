          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Container(
                  decoration: BoxDecoration(borderRadius: BorderRadius.circular(12),                  color: ColorsManager.primaryBackground,
                  ),
                    child: Padding(
                      padding: const EdgeInsets.all(8.0),
                      child: Text("All Products",style: GoogleFonts.dmSans(fontSize: 16,fontWeight: FontWeight.w500),),
                    )),
                ...
                Padding(
                  ...
                  child: SizedBox(
                    ...
                    child: CustomFutureBuilder<ResturantProductModel>(
                      ...
                      onData: (BuildContext context, ResturantProductModel data) {
                            ...
                            return InkWell(
                              onTap: (){
                                Get.toNamed(
                                  ...
                                  arguments: {
                                    "product_id": int.parse(data.data![index].id.toString()),
                              ...
                              child: Padding(
                                ...
                                child: Container(
                                  child: Row(
                                    children: [
                                      AppCashedImage(
                                        imageUrl: data.data?[index].images?[0].toString()??"",
                                        width: 89.w,
                                        height: 75.h,
                                        fit: BoxFit.cover,
                                        radius: 20,
