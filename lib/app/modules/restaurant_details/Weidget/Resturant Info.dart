            ...
            Row(
              ...
              children: [
                Column(
                  ...
                  children: [
                    Text(res_Details!.arName.toString(),style:  GoogleFonts.dmSans(color: const Color(0xff101010),fontSize: 16,fontWeight: FontWeight.w500),),
                    SizedBox(height: 5.h,),
                    Container(child: Row(
                      children: [
                        Text(res_Details.rate.toString(),style:  GoogleFonts.dmSans(fontSize: 14,fontWeight: FontWeight.w400,color: const Color(0xff878787)),),
                       SizedBox(width: 4,),
                  ...
                  children: [
                    Container(
                      child: Row(
                        children: [
                          ...
                          Text(res_Details.deliveryTime.toString(),style:  GoogleFonts.dmSans(fontWeight: FontWeight.w400,fontSize: 12,color: const Color(0xff878787)),),
                        ],
                      ),
                    ),
                    SizedBox(height: 5.h,),
                    ...
                    Container(
                      child: Row(
                        ...
                        children: [
                          const Icon(Icons.delivery_dining,color: Color(0xff878787),weight: 0.1,),
                          SizedBox(width: 3.w,),
