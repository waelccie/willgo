                ...
                child: CustomFutureBuilder<x.ProductDetails>(
                  ...
                  onData: (context, data){
                    ...
                    return Column(
                      ...
                      children: [
                        product_Info(context,product!.enName,product.price,product.currentPrice,product.rate,0,product.isDiscount as bool,product.images?[0]),
                        SizedBox(height: 12.h,),
                         FoodDescriptionCard(
                          description: product.description.toString(),
                          nutritionalInfo: {
                           "info": product.nutritionalInformation.toString()
                          },
                        ),
                        SizedBox(height: 12.h,),
